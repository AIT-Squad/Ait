---
name: ait-discuss
description: INVOKE THIS SKILL when the user asks to write or discuss a product requirement document with `/ait prdv1 <title>` (PRD authoring stage).
---
...
- `project-docs/.ait/ait-cli prdv1 create <title>`
- `project-docs/.ait/ait-cli baseline-summary --scope prd --format yaml`
- `project-docs/.ait/ait-cli context <overrides>`
- `project-docs/.ait/ait-cli prdv1 resolve-candidates --from-file <file>`
- `project-docs/.ait/ait-cli prdv1 save-draft <req_id> --content-file <file>`
- `project-docs/.ait/ait-cli prdv1 confirm <req_id> --file <slug>`
...
- **Writes**: only through `project-docs/.ait/ait-cli prdv1 save-draft`, `prdv1 resolve-candidates`, and `prdv1 confirm`.
...
2. Call `project-docs/.ait/ait-cli prdv1 create <title>` and record `req_id` and `version`.
...
10. Wait for explicit user confirmation before calling `project-docs/.ait/ait-cli prdv1 resolve-candidates --from-file <file>`.
...
17. Call `project-docs/.ait/ait-cli prdv1 save-draft <req_id> --content-file <file>`.
18. Call `project-docs/.ait/ait-cli prdv1 confirm <req_id> --file <slug>`.
