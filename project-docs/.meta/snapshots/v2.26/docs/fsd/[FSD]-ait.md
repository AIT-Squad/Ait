...
## init 域
```yaml
depends_on: [foundation, indexing, specgraph, version]
```
### 功能描述
...
## prd 域
```yaml
depends_on: [doc_model, foundation, indexing, lint, specgraph, state, version]
```
### 功能描述
...
## version 域
```yaml
depends_on: [doc_model, foundation, indexing, lint, specgraph, state, task]
```
### 功能描述
...
## new-model 域
```yaml
depends_on: [doc_model, indexing, lint, specgraph, version]
```
### 功能描述
...
## specgraph 域
```yaml
depends_on: [doc_model, foundation, indexing, version]
```
### 功能描述
...
## context 域
```yaml
depends_on: [doc_model, indexing, specgraph, version]
```
### 功能描述
...
## indexing 域
```yaml
depends_on: [doc_model, foundation, task]
```
### 功能描述
...
## cli 分发器
```yaml
depends_on: [context, foundation, impl, indexing, init, lint, new_model, prd, search, specgraph, state, task, version]
```
### 功能描述
