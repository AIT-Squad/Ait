...
<!-- @summary: skill 清单与 sub-skills 指令层；details 到各 SKILL.md 文件。 -->
...
<!-- @summary: AIT skill 主清单（Claude 的 AIT 使用指令）。新模型为主叙事：开篇 Pipeline 以 prd(新模型)/fsd/td details [TDD]-skill_manifest。 -->
...
<!-- @summary: 旧模型 PRD 讨论 sub-skill（触发 /ait prdv1 <title>）：Clarify→Design→Generate，经  details [TDD]-subskill_ait_discuss。 -->
...
<!-- @summary: impl 规划 sub-skill：读上下文、生成 impl chunk（含 @extract）、注册到版本工作区。 details [TDD]-subskill_ait_impl_discuss。 -->
...
<!-- @summary: init 差异补全引导 sub-skill：逐项确认 global 文件是否补齐。 details [TDD]-subskill_ait_init_guide。 -->
...
<!-- @summary: 错误恢复 sub-skill：按 CLI JSON code 给恢复步骤（含 version reset 指引）。 details [TDD]-subskill_ait_resume。 -->
...
<!-- @summary: 状态面板 sub-skill：调用 state 渲染面板，兼进度查询、未完成项叙述。 details [TDD]-subskill_ait_state。 -->
...
<!-- @summary: task 执行 sub-skill：据聚焦 context bundle 驱动 AI 编码，完成调用 task complete/fail  details [TDD]-subskill_ait_task_execute。 -->
